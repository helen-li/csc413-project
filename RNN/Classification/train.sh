...
srun -p csc413 --gres gpu -c 2 --pty python3 main.py --gt-rules 2 --model Modular --num-rules 2 --joint
srun -p csc413 --gres gpu -c 2 --pty python3 main.py --gt-rules 4 --model Modular --num-rules 4 --joint
srun -p csc413 --gres gpu -c 2 --pty python3 main.py --gt-rules 8 --model Modular --num-rules 8 --joint
srun -p csc413 --gres gpu -c 2 --pty python3 main.py --gt-rules 16 --model Modular --num-rules 16 --joint
srun -p csc413 --gres gpu -c 2 --pty python3 main.py --gt-rules 32 --model Modular --num-rules 32 --joint
