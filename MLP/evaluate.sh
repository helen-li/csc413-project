...
srun -p csc413 --gres gpu -c 2 --pty python3 perf.py --gt-rules 2 --model Modular --num-rules 2 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 perf.py --gt-rules 4 --model Modular --num-rules 4 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 perf.py --gt-rules 8 --model Modular --num-rules 8 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 perf.py --gt-rules 16 --model Modular --num-rules 16 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 perf.py --gt-rules 32 --model Modular --num-rules 32 --op --joint
...
srun -p csc413 --gres gpu -c 2 --pty python3 spec.py --gt-rules 2 --model Modular --num-rules 2 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 spec.py --gt-rules 4 --model Modular --num-rules 4 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 spec.py --gt-rules 8 --model Modular --num-rules 8 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 spec.py --gt-rules 16 --model Modular --num-rules 16 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 spec.py --gt-rules 32 --model Modular --num-rules 32 --op --joint
...
srun -p csc413 --gres gpu -c 2 --pty python3 prob.py --gt-rules 2 --model Modular --num-rules 2 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 prob.py --gt-rules 4 --model Modular --num-rules 4 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 prob.py --gt-rules 8 --model Modular --num-rules 8 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 prob.py --gt-rules 16 --model Modular --num-rules 16 --op --joint
srun -p csc413 --gres gpu -c 2 --pty python3 prob.py --gt-rules 32 --model Modular --num-rules 32 --op --joint
